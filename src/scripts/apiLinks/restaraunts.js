...
const searchRestaurants = searchInput => fetch(`${restaurantBaseUrl}/search?entity_id=1138&entity_type=city&start=first&sort=rating&apikey=${restaurantApiKey}&q=${searchInput}`)
